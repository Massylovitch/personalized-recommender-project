...
class FeatureGroupUpdater:
    ...
    def _prepare_transaction_for_insertion(self, purchase_data: dict):
    ...
    def _prepare_interactions_for_insertion(self, df):
    ...
    def process_interactions(self, tracker, force: bool = False):
