...
class TwoTowerDataset:
    def __init__(self, feature_view, batch_size):
...
class QueryTowerFactory:
    ...
    def build(self, embed_dim=settings.TWO_TOWER_MODEL_EMBEDDING_SIZE):
        return QueryTower(
...
class QueryTower(tf.keras.Model):
    def __init__(self, user_ids, emb_dim) -> None:
        super().__init__()
...
class ItemTowerFactory:
    ...
    def build(self, embed_dim: int = settings.TWO_TOWER_MODEL_EMBEDDING_SIZE):
        return ItemTower(
